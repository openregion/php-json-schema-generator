...
class BaseParser
{
   ...
   */
  protected array $configSchemaRequiredFields = [];
   ...
   * @return $this
   */
  protected function appendProperty($key, Definition $property): self
  {
   ...
   */
  protected function loadSchema(): self
  {
   ...
   */
  public function parse($subject = null): self
  {
   ...
   * @throws \JSONSchemaGenerator\Parsers\Exceptions\UnmappableException
   */
  protected function loadObjectProperties($inputVar): void
  {
   ...
   * @throws \JSONSchemaGenerator\Parsers\Exceptions\UnmappableException
   */
  protected function determineProperty($property, ?string $id = null): Definition
  {
